...
class NeuralNet:
    def __init__(self, class_weight=False, **params):
        ...
        self.default_params = {
            ...
            'monitor': 'val_loss',
            'min_delta': 1e-4,
            'use_batch_norm': True  # New parameter to control batch normalization
        }
    ...
    def fit(self, X, y, validation_data=None, epochs = 2000, **kwargs):
        if self.model is None:
            self.create_model(X, y)
        
        reduce_lr = ReduceLROnPlateau(monitor='val_loss',
                            factor=0.5,  # Factor by which the learning rate will be reduced (halved in this case)
